	...
	return fmt.Sprintf(
      ...
      <mj-section background-color="#FFFFFF" padding="24px" border-radius="10px">
          ...
          <mj-text font-weight="bold" font-size="24px" padding="30px 0">
            Validate Your FirstCert Account
          </mj-text>
          ...
          <mj-text>
            We would love to have you on board! Please validate your registration with us.
					...
					<mj-text line-height="24px" padding="24px 10%%">
						If you believe you have received this email in error, please delete it and notify <a href="mailto:support@first-cert.com">support@first-cert.com</a>
					</mj-text>
				</mj-column>
      </mj-section>
      ...
      <mj-section>
        <mj-column>
					<mj-text color="#FFFFFF">
						FirstCert Copyrights © 2024. All right reserved
					</mj-text>
				</mj-column>
			</mj-section>
		</mj-body>
	</mjml>
	  `, username, acceptInvitationLink,
	)
}
