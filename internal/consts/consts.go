...
const FIRST_CERT_API_URL = "http://localhost:8085"

// Cache Prefix
const CACHE_USER_ID = "UserID:"
const CACHE_USER_PLAN_ID = "UserPlanID:"
const CACHE_COMPANY_ID = "CompanyID:"                                      //Media, Companysubscription
const CACHE_COMPANY_ACCOUNTS_BY_COMPANY_ID = "CompanyAccountsByCompanyID:" //Role, Permissions, Feature
const CACHE_COMPANY_ACCOUNTS_BY_USER_ID = "CompanyAccountsByUserID:"       //Role, Permissions, Feature
const CACHE_PERMISSIONS_BY_ROLE_ID = "PermissionsByRoleID:"                //Feature
const CACHE_JOBS = "Jobs:"                                                 //JobQuestion
const CACHE_JOBS_BY_COMPANY_ID = "JobsByCompanyID:"                        //JobQuestion
const CACHE_JOB_ID = "JobID:"                                              //JobQuestion
const CACHE_APPLICATION_ID = "ApplicationID:"                              //Media, Activity, Schedules
const CACHE_APPLICATIONS_BY_JOB_ID = "ApplicationsByJobID:"                //Activity
const CACHE_APPLICATIONS_BY_USER_ID = "ApplicationsByUserID:"              //Job, Media, Activity, Schedules
