...
// FirstCert
func (s *sUser) GetCertificateFirstCert(ctx context.Context, accountID string) (*map[string]interface{}, error) {
	url := consts.FIRST_CERT_API_URL + "/certificate/account/" + accountID
	...
	if resp.StatusCode != http.StatusOK {
		g.Log().Error("Failed to Get FirstCert: ", resp.StatusCode)
		err = gerror.NewCode(gcode.CodeInvalidRequest, "Failed to Get FirstCert")
		return nil, err
	}
