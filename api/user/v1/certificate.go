...
// FirstCert
type GetCertificateFirstCertReq struct {
	g.Meta `path:"/certificate/firstcert" tags:"User" method:"get" summary:"Get First Cert"`
}

type GetCertificateFirstCertRes struct {
	FirstCertCertificates *map[string]interface{}
}

// type PostCreateCertificateFirstCertReq struct {
// 	g.Meta `path:"/certificate/firstcert" tags:"User" method:"post" summary:"Create First Cert"`

// }

// type PostCreateCertificateFirstCertRes struct {
// 	Id     string      `json:"id"`
// }
